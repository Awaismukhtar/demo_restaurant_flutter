...
import 'package:demo_app/pin_decoration.dart';
    ...
    final PhoneVerificationCompleted verificationCompleted = (AuthCredential phoneAuthCredential) {
      _firebaseAuth.signInWithCredential(phoneAuthCredential).then((AuthResult value) async {
        if (value.user != null) {
          ...
          bool check  = await DataBase().checkUser(value.user.uid);
          if(check==true){
            ...
            String retString = await DataBase().createUser(user);
...
*/
      ...
      showToast("Error validating OTP, Please try again",Colors.red);
    });
